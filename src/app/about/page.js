...
//   return (
//     // Force a light canvas; keep minimal page padding; chart goes full-bleed on mobile
//     <div className="min-h-screen bg-white text-black px-4 sm:px-6 lg:px-8 py-4">
//       {/* Title bar */}
//       <h1 className="bg-gradient-to-b from-[#2A3E83] via-[#1655A0] to-[#016CCE] text-white p-3 rounded-md text-2xl font-bold mb-3">
//         About
//       </h1>

//       {/* Content — simple vertical flow, no card wrapper */}
//       <div className="flex flex-col gap-6">
//         {/* About */}
//         <section id="about">
//           <h2 className="text-xl font-semibold text-black">About NYC Eat Safe</h2>
//           <p className="text-gray-800 leading-relaxed">
//             NYC Eat Safe helps New Yorkers make better dining decisions by presenting inspection data
//             in a clear, searchable way, so you can spot trends and choose where to eat with confidence.
//           </p>
//           <p className="text-gray-800 leading-relaxed mt-2">
//             All information comes directly from the NYC Department of Health and Mental Hygiene (DOHMH).
//             Grades and violations reflect the most recent inspection.
//           </p>
//           <p className="text-gray-800 leading-relaxed mt-2">
...
//         {/* Score Distribution — FULL BLEED on mobile */}
//         <section id="chart" className="-mx-4 sm:mx-0">
//           <h2 className="text-xl font-semibold text-black mb-2 px-4 sm:px-0">Score Distribution</h2>
//           <div className="w-full m-0 p-0">
//             <ScoreHistogram bins={bins} height={300} />
//           </div>
//           {!bins?.length && (
//             <p className="text-sm text-slate-500 mt-2 px-4 sm:px-0">
