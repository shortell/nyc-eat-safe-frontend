...
export default function RestaurantPage() {
  ...
  const camis = params?.camis;        // ✅ safely access camis

  return (
    <>
      <Head>
        <link rel="canonical" href={`https://www.nyceatsafe.com/restaurant/${camis}`} />
        <title>Restaurant {camis} | NYC Eat Safe</title>
      </Head>
  ...
  return (
    <div className="w-full min-h-screen bg-[#f5f2fa] py-8 px-2">
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8">
        ...
        <div className="space-y-8">
          {restaurant_profile.map((insp, idx) => (
            <section key={idx} className="bg-[#f9f7fc] rounded-xl shadow border p-5">
              <div className="flex flex-wrap items-center gap-4 mb-2">
                <h2 className="text-lg font-semibold text-[#2a3d83]">
                  {insp.inspection_type}
                </h2>
